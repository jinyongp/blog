...
lastmod: 2023-08-15T09:35:19.915Z
draft: false
tags:
  - nbcamp
  - swift
...
<div class="flex gap-2 md:gap-5 justify-center">
  <img class="shadow-md" src="/image/learn/nbcamp/5/main-page.png" width="23%" alt="Main Page">
  <img class="shadow-md" src="/image/learn/nbcamp/5/completes-page.png" width="23%" alt="Completes Page">
  <img class="shadow-md" src="/image/learn/nbcamp/5/add-new-item.png" width="23%" alt="Completes Page">
  <img class="shadow-md" src="/image/learn/nbcamp/5/edit-item.png" width="23%" alt="Completes Page">
</div>
